...
import { assetTypesData } from '../Data/Data.js';
...
const AssetTypes = () => {
  const [data, setData] = useState(assetTypesData);
  ...
  const handleExportCsv = () => {
    ...
    link.setAttribute("download", "assettypes.csv");
  ...
  return (
    ...
    <h2 className="text-center text-xl font-semibold mb-2">Asset type list</h2>
